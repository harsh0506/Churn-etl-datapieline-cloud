-- let's look at the table ,first five rows 
...
SELECT * FROM customer_data WHERE credit_score IS NULL;
SELECT * FROM customer_data WHERE age IS NULL;
SELECT * FROM customer_data WHERE balance IS NULL;
SELECT * FROM customer_data WHERE estimated_salary IS NULL;
SELECT * FROM customer_data WHERE tenure IS NULL;
SELECT * FROM customer_data WHERE country IS NULL;
SELECT * FROM customer_data WHERE gender IS NULL;
SELECT * FROM customer_data WHERE products_number IS NULL;
SELECT * FROM customer_data WHERE credit_card IS NULL;
SELECT * FROM customer_data WHERE active_number IS NULL;
SELECT * FROM customer_data WHERE churn IS NULL;
...
select active_member,count(*),gender from customer_data group by active_member,gender;


-- lets look at the customers with higher and lower balance to salary ratio,mostly top 5
select * from (
	select 
